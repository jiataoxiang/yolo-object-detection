...
source_label_path = './dataset/train/labels/'
source_image_path = './dataset/train/images/'
destination_label_path = './dataset/test/labels/'
destination_image_path = './dataset/test/images/'
